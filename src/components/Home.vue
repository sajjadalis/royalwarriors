        ...
        <div class="grid grid-cols-1 md:grid-cols-5 md:gap-10">
            ...
            <div class="mt-10 md:mt-0 md:col-span-2 row-start-2 md:row-start-1">
                ...
                <div class="w-full p-3 md:p-10 shadow-xl rounded-lg">
                    <h2 class="text-center mb-3 text-2xl font-heading font-bold">Browse Previous Hunting Reports</h2>
                    <select class="w-full border border-gray-400 rounded py-2 px-4 font-medium" @change="redirectPage($event)">
...
export default {
    ...
    methods: {
        ...
        scoreChart(){  
            let data = "/data/totalsForCharts.csv";
